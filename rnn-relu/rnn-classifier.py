...
from pybrain import LinearLayer, FullConnection, LSTMLayer, BiasUnit, MDLSTMLayer, IdentityConnection, TanhLayer, SoftmaxLayer, SigmoidLayer, ReluLayer
...
vanillaRNN.addModule(ReluLayer(44, name='hidden'))
...
trnErrorPath='44relu/trn_error'
tstErrorPath='44relu/tst_error'
trnClassErrorPath='44relu/trn_ClassAccu'
tstClassErrorPath='44relu/tst_ClassAccu'
networkPath='44relu/TrainUntilConv.xml'
figPath='44relu/ErrorGraph'
...
while (tstErrorCount<100):
    print "********** Classification with 44relu with RP- **********"   
...
np.savetxt("44relu/Trainingtime.txt", trainingTime)


# vanillaRNN = NetworkReader.readFrom('44relu/TrainUntilConv.xml')
# trainer = RPropMinusTrainer(vanillaRNN, dataset=trndata, verbose=True, weightdecay=0.01)
