...
LSTMClassificationNet = NetworkReader.readFrom('44sigmoid(1)/TrainUntilConv.xml')
print 'Loaded 44sigmoid RNN Trained Network!'
...
plt.errorbar(y=twentylstmaccdata, x=np.arange(0.0,2.1,0.1), yerr=twentylstmstderror, label="44 Sigmoids", linewidth=2)
plt.xlim([0.0,2.1])
plt.xlabel(r"$\sigma$")
