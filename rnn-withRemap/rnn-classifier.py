...
trnErrorPath='44sigmoid(1)/trn_error'
tstErrorPath='44sigmoid(1)/tst_error'
trnClassErrorPath='44sigmoid(1)/trn_ClassAccu'
tstClassErrorPath='44sigmoid(1)/tst_ClassAccu'
networkPath='44sigmoid(1)/TrainUntilConv.xml'
figPath='44sigmoid(1)/ErrorGraph'
...
while (tstErrorCount<100):
    print "********** Classification with 44sigmoid(1) with RP- **********"   
...
np.savetxt("44sigmoid(1)/Trainingtime.txt", trainingTime)