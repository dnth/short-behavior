...
trndata = ClassificationDataSet(500,1, nb_classes=6)
tstdata = ClassificationDataSet(500,1, nb_classes=6)
...
TDNNClassificationNet = buildNetwork(trndata.indim,5,trndata.outdim, hiddenclass=SigmoidLayer, outclass=SoftmaxLayer) 
...
trnErrorPath='5sigmoid/trn_error'
tstErrorPath='5sigmoid/tst_error'
trnClassErrorPath='5sigmoid/trn_ClassAccu'
tstClassErrorPath='5sigmoid/tst_ClassAccu'
networkPath='5sigmoid/TrainUntilConv.xml'
figPath='5sigmoid/ErrorGraph'
...
# np.savetxt("5sigmoid/Trainingtime.txt", trainingTime)


####################
# Manual OFFLINE Test
####################        
MLPClassificationNet = NetworkReader.readFrom('5sigmoid/TrainUntilConv.xml')
...
x = TDNNClassificationNet.activate(BR[7000:7500])
print argmax(x)