...
testingdata = ClassificationDataSet(100,1, nb_classes=6)
for i in range(80000,100000,100):
    testingdata.addSample(BL[i:i+100], [0])
    testingdata.addSample(BR[i:i+100], [1])
    testingdata.addSample(BRL[i:i+100], [2])
    testingdata.addSample(BRR[i:i+100], [3])
    testingdata.addSample(BRP[i:i+100], [4])
    testingdata.addSample(RW[i:i+100], [5])
